"""Phase 0 HighFrequencyResidualFNO prototype for NeuralOperator smoke runs.

This module is intentionally small and self-contained. It imports NeuralOperator
only when instantiated by the controller-owned benchmark.
"""
...
class HighFrequencyResidualFNO(nn.Module):
    """FNO backbone plus a local residual branch for high-frequency correction."""
